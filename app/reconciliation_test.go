...
// func FuzzParseDenomFromBalanceKey(f *testing.F) {
// 	f.Add("0214cf150037e47b0c53e826a2d0050de1da2c8f5caa424e42")
// 	f.Fuzz(func(t *testing.T, a string) {
// 		key, _ := hex.DecodeString(a)
// 		if parseDenomFromBalanceKey(key) != "BNB" {
// 			t.Errorf("error string %s", a)
// 		}
// 	})
// }
...
// func FuzzParseAddressFromBalanceKey(f *testing.F) {
// 	f.Add("0214040ffd5925d40e11c67b7238a7fc9957850b8b9a424e42")
// 	f.Fuzz(func(t *testing.T, a string) {
// 		key, _ := hex.DecodeString(a)
// 		parseAddressFromBalanceKey(key)
// 	})
...
// func FuzzParseDenomFromSupplyKey(f *testing.F) {
// 	f.Add("00424e42")
// 	f.Fuzz(func(t *testing.T, a string) {
// 		key, _ := hex.DecodeString(a)
// 		if parseDenomFromSupplyKey(key) != "BNB" {
// 			t.Errorf("error string %s", a)
// 		}
// 	})
// }
